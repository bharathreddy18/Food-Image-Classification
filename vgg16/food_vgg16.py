...
if __name__ == '__main__':
    try:
        ...
        food_vgg16.evaluate_model(filename='vgg16_metrics.json')
        food_vgg16.checking(file_path=r'C:\Users\Admin\Desktop\Internship\Task-1\Food Classification dataset\burger\001.jpg')
